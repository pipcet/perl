...
Perl_new_collate(pTHX_ const char *newcoll)
{
...

	{
            ...
            /* We use the string below to test how long the tranformation of it
             ...
             * weight levels as the ASCII ones.  Also, letters tend to have
             * more weight levels than other types of characters.  This all
             * should increase the chances that we will choose 'm' and 'b'
             * large enough to avoid having to recalculate transformations
             * because our initial sizing was too small */
             ...
             * 'b'.  This assumes a weight can be any UV on the platform, and
             * there are 5 levels, plus a UV-size amount of per-string
             * overhead. */
